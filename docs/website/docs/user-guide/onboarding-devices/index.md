...
For device-specific installation and deployment steps, coordinate with your Hub operator. Operator-facing setup instructions live in the [Administrator & Operator Guide](/docs/operator-guide/player-installation-to-device).
